...
import { calculateGCD, checkInteger, getPrimeFactors, id } from './_math';
...
export const FactorHintCard: React.FC<CardProps> = ({ problem, onSuccess, onFailure, onShowSolution, onHideSolution, onSkip }) => {
  const { t } = useLanguage();
