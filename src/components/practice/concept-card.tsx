  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="bg-gray-50 rounded-3xl p-6 mb-8 text-center border border-gray-100 relative z-10">
          <p className="text-xs font-black text-gray-400 uppercase tracking-widest mb-3">Key Formula</p>
        ...
        <button
          onClick={onStart}
          className="w-full py-4 bg-gray-900 text-white font-black rounded-2xl hover:bg-gray-800 transition-all hover:scale-[1.02] active:scale-[0.98] shadow-xl relative z-10"
        >
          {t.concepts.start}
        </button>
      </motion.div>
